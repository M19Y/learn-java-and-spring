...
public class BulkheadConfigTest {
  ...
  @Test
  void testSemaphoreWithConfig() throws InterruptedException {
    ...
    // bulkhead max concurrent call is 25 (default)
    Bulkhead bulkhead = Bulkhead.of("unc", config);
  ...
  void testThreadPoolWithConfig() throws InterruptedException {
    ...
    ThreadPoolBulkhead threadPoolBulkhead = ThreadPoolBulkhead.of("aunty", config);
